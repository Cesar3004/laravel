...
<body> 
    ...
    <script>
        ...
        strings: ['<span><i class="fas fa-paint-brush"></i></span> NUTRITIVA', 
                    '<span><i class="fas fa-building"></i></span> ACCESIBLE'
                    ,'<span><i class="fas fa-coffee"></i></span> Y NATURAL'],
